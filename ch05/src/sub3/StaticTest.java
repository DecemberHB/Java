...
/**
 * 
 * 날짜 : 2025/07/14 이름 : 박효빈 내용 : Static 변수(클래스변수), Static 매서드(클래스 매서드) 실습하기
 * 
 * 
 * 클래스 변수(정적변수), 클래스 메서드 - static으로 선언한 변수와 메서드 - Method Area 영역에 따로 관리 됨 - new
 * 객체 생성 없이 바로 클래스 타입으로 참조 - 객체 (인스턴스) 간의 데이터 공유 목적으로 활용 -
 * 
 * 
 */
...
public class StaticTest {
	...
	public static void main(String[] args) {
		...
		/// - 외부생성을 막기 위해 private 생성자 선언
		////////////////////////////////////////////////
		// 여러개 객체를 생성할 필요가 없는 객체
		// Calc cal = new Calc(); //동적 생성을 막아야함(싱글톤 생성시)
		// int result = cal.plus(1, 2);
		// System.out.println("result : " + result);

		Calc c1 = Calc.getInstance(); // Settet 처리해놨으니 gettet로 불러야함
		Calc c2 = Calc.getInstance();
		Calc c3 = Calc.getInstance();
		System.out.println("1 + 2 : " + c1.plus(1, 2));
		System.out.println("1 - 2 : " + c1.minus(1, 2));
		System.out.println("2 * 3 : " + c1.multi(2, 3));
		System.out.println("4 / 2 : " + c1.div(4, 2));
