...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		//논리연산자
		int var3 = 3, var4 = 4;
		boolean res1 = (var3 > 3) && (var4 > 3); //var3는 3보다 크고 그리고 var4는 3보다 크다
		boolean res2 = (var3 > 2) && (var4 > 3); //var3는 2보다 크고 그리고 var4는 3보다 크다
		boolean res3 = (var3 > 3) || (var4 > 3); //var3는 3보다 크고 또는 var4는 3보다 크다
		boolean res4 = (var3 > 4) || (var4 > 5); //var3는 4보다 크고 또는 var4는 5보다 크다
		boolean res5 = !(var3 > var4); //반전시킴  원래의 값은 fales이나 반전 되어 ture가 된다
