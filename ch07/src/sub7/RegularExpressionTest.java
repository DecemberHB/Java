...
public class RegularExpressionTest {
	...
	public static void main(String[] args) {
		...
		// 자주 사용하는 정규표현식
				String input = "a101,홍길동,010-1234-1001,hong@gmail.com"; //id,이름,폰번,email

				// 패턴 정의
				String ptt1 = "^[a-z][a-z0-9]{3,10}$"; // 영어 소문자 1자로 시작하고 소문자, 숫자 3자리 이상 10자리 미만(>> {3,10})
				String ptt2 = "^[가-힣]*$";
				...
				// Matcher 생성
				Matcher m1 = p1.matcher(input.split(",")[0]); // ,로 자르고 0번째에 넣는거
