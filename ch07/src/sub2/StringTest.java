...
public class StringTest {
	public static void main(String[] args) {
		...
		// ** 매우 중요 ** >> equals 비교 << 문자열 비교는 반드시 equals로 비교
		if(str1.equals(str2)) {
		...
		int idx2 = message.lastIndexOf('e'); // 문자열의 뒤에서부터 문자 e 탐색
		
		System.out.println("idx1 : " + idx1);
		System.out.println("idx2 : " + idx2);
		//문자열 분리
		String[] words = message.split(","); // 구분자 , 로 분리
		...
		//문자열 변환
		int var1 = 1;
		double var2 = 2.1; //var2+""로도 가능
		boolean var3 = true;
		
		String s1 = String.valueOf(var1);
		String s2 = String.valueOf(var2);
		String s3 = "" + var3; // 이런 방식으로 많이 사용함
